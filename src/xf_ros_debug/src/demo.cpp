...
void TTSCallback(const std_msgs::String::ConstPtr &msg)
{
	...
	// ROS_INFO("get topic text:",msg->data.c_str());
...
{  
    ...
    ros::init(argc, argv, "xf_tts_demo_debug_node");  
    ros::NodeHandle n;  
          
    chatter_pub = n.advertise<std_msgs::Int32>("/voice/xf_asr_topic", 1000);  
    sub = n.subscribe("/voice/xf_tts_topic", 3, &TTSCallback);  
